 ...
 * @LastEditTime: 2022-08-25 10:08:40
 * @Description:
 */
...
namespace localization
{
    ...
    bool undistortedPoint::deskew(std::deque<ImuData> &imu_data, std::deque<GnssData> &gnss_data, CloudData raw_cloud, CloudData deskewedCloud)
    {
    }
} // namespace localization
