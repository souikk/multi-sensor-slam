 ...
 * @LastEditTime: 2022-08-26 13:04:03
 * @Description:
 */
...
namespace localization
{
                                  ...
                                  CloudData deskewedCloud)
    {
        ...
        Eigen::Vector3d ori_point_trans;
        Eigen::Quaterniond ori_point_rot;
        for (size_t i = 0; i < raw_cloud.size(); i++)
        {
            ...
            if (i == 0)
            {
                ori_point_rot = cur_point_rot;
                ori_point_trans = ori_point_trans;
                continue;
            }
        }
    }
