 ...
 * @LastEditTime: 2022-09-02 17:46:05
 * @Description:
 */
...
namespace localization
{
    ...
    bool ImuData::syncPointCloud(double timestamp, std::deque<ImuData> imu_buf, ImuData &sync_imu_data)
    {
        ...
        Eigen::Quaterniond q0(data_front.orientation.w,
                              data_front.orientation.x,
                              data_front.orientation.y,
                              data_front.orientation.z);
        Eigen::Quaterniond q1(data_back.orientation.w,
                              data_back.orientation.x,
                              data_back.orientation.y,
                              data_back.orientation.z);
