 ...
 * @LastEditTime: 2022-08-25 15:27:27
...
namespace localization
{
    ...
    void PreprocessDataFlow::initExtrinsic_parameter()
    {
        ...
        trans.clear();
        rot.clear();
        LOG(INFO) << "trans:" << imu2lidar_trans[0] << ", " << imu2lidar_trans[1] << ", " << imu2lidar_trans[2];
        ...
        trans.clear();
        rot.clear();
        LOG(INFO) << "trans:" << gnss2lidar_trans[0] << ", " << gnss2lidar_trans[1] << ", " << gnss2lidar_trans[2];
    }
