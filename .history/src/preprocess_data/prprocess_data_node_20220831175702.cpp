 ...
 * @LastEditTime: 2022-08-31 17:57:02
 * @Description:
 */
...
namespace localization
{
    ...
    bool PreprocessDataNode::deskewPoint(CloudData::pointType &point, double point_time)
    {
        ...
        if (frist_point_flag_ == true)
        {
            ...
            deskewed_cloud.cloud_ptr_->points[i].x = raw_cloud.points[i].x;
            deskewed_cloud.cloud_ptr_->points[i].y = raw_cloud.points[i].y;
            deskewed_cloud.cloud_ptr_->points[i].z = raw_cloud.points[i].z;
            deskewed_cloud.cloud_ptr_->points[i].intensity = raw_cloud.points[i].intensity;
            continue;
        }
