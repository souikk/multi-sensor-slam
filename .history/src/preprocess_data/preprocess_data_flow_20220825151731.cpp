 ...
 * @LastEditTime: 2022-08-25 15:17:15
...
namespace localization
{
    ...
    void PreprocessDataFlow::initExtrinsic_parameter()
    {
        ...
        Eigen::Vector3d imu2lidar_rot = Eigen::Map<const Eigen::Matrix<double, -1, -1, Eigen::RowMajor>>(rot.data(), 3, 3);
        ...
        Eigen::Vector3d gnss2lidar_rot = Eigen::Map<const Eigen::Matrix<double, -1, -1, Eigen::RowMajor>>(rot.data(), 3, 3);
