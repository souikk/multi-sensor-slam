 ...
 * @LastEditTime: 2022-08-31 17:04:51
 * @Description:
 */
...
namespace localization
{
    ...
    bool PreprocessDataNode::deskewPoint(CloudData::pointType &point, double point_time)
    {
        ...
        double front_scale = (gnss_time_[j].time - point_time) / (gnss_time_[j].time - gnss_time_[j - 1].time);
        double back_scale = (point_time - gnss_time_[j - 1].time) / (gnss_time_[j].time - gnss_time_[j - 1].time);
