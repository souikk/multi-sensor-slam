 ...
 * @LastEditTime: 2022-08-29 19:32:25
 * @Description:
 */
...
namespace localization
{
    PreprocessDataNode::PreprocessDataNode(const rclcpp::NodeOptions &options) : Node("PreprocessData", options)
    {
        ...
        lidarMinRange_ = config["preprocess"]["lidarMinRange"].as<double>();
        lidarMaxRange_ = config["preprocess"]["lidarMaxRange"].as<double>();
    ...
    bool PreprocessDataNode::currentCloudInfo(sensor_msgs::msg::PointCloud2 currentCloudMsg)
    {
        ...
        timeScanEnd_ = laserCloudIn->points.back().timestamp;
