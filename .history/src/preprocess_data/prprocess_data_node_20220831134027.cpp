 ...
 * @LastEditTime: 2022-08-31 13:39:35
 * @Description:
 */
...
namespace localization
{
    ...
    bool PreprocessDataNode::pointDeskew(PointXYZIRT point)
    {
    }
    ...
    double PreprocessDataNode::pointDistance(PointXYZIRT point)
    {
