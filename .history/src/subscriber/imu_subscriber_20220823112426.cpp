 ...
 * @LastEditTime: 2022-08-23 11:24:10
 * @Description:
 */
...
namespace localization
{
    ...
    {
        node_ptr_ = node_ptr;
        rmw_qos_history_policy_t hp = RMW_QOS_POLICY_HISTORY_KEEP_ALL;
        rmw_qos_profile_t qos_profile{
            RMW_QOS_POLICY_HISTORY_KEEP_ALL,     // history,保留近期记录(Keep last)： 缓存最多N条记录，可通过队列长度选项来配置。
