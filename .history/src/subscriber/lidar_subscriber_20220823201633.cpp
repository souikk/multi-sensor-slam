 ...
 * @LastEditTime: 2022-08-23 20:16:33
 * @Description:
 */
...
{
    LidarSubscriber::LidarSubscriber(rclcpp::Node::SharedPtr node_ptr, std::string topic_name, size_t queue_size, int policy_history)
    {
        node_ptr_ = node_ptr;
        ...
        subLidar_ = node_ptr_->create_subscription<sensor_msgs::msg::PointCloud2>(
            topic_name, qos, std::bind(&LidarSubscriber::lidarCallback, this, std::placeholders::_1));
    }
    ...
    void LidarSubscriber::accessData(std::deque<sensor_msgs::msg::PointCloud2> &cloud_buff)
    {
    }
