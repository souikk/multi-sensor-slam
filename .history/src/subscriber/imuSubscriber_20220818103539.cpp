 ...
 * @LastEditTime: 2022-08-18 10:35:39
 * @Description
 */
...
namespace localization
{
    ImuSubscriber::ImuSubscriber(rclcpp::Node::SharedPtr node_ptr)
    {
        ...
        subImu_ = node_ptr_->create_subscription<sensor_msgs::msg::Imu>("imu/data", Qos(10), std::bind(&ImuSubscriber::ImuSubscriber, this, _1));
    }
