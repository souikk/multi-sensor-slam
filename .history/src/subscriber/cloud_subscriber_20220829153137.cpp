 ...
 * @LastEditTime: 2022-08-29 15:31:37
 * @Description:
 */
...
{
    CloudSubscriber::CloudSubscriber(std::shared_ptr<PreprocessDataNode> node_ptr, std::string topic_name, size_t queue_size, int policy_history)
    {
        node_ptr_ = node_ptr;
