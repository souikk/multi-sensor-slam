 ...
 * @LastEditTime: 2022-08-23 11:18:05
 * @Description:
 */
...
{
    GnssSubscriber::GnssSubscriber(rclcpp::Node::SharedPtr node_ptr, std::string topic_name, size_t queue_size,int policy_history)
    {
        node_ptr_ = node_ptr;
