 ...
 * @LastEditTime: 2022-08-26 15:48:00
 * @Description:
 */
...
{
    cloudSubscriber::LidarSubscriber(rclcpp::Node::SharedPtr node_ptr, std::string topic_name, size_t queue_size, int policy_history)
    {
        node_ptr_ = node_ptr;
    ...
    void cloudSubscriber::lidarCallback(sensor_msgs::msg::PointCloud2::SharedPtr msg)
    {
