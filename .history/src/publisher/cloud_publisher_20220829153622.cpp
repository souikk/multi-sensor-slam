 ...
 * @LastEditTime: 2022-08-29 15:36:22
 * @Description:
 */
...
{
    CloudPublisher::CloudPublisher(std::shared_ptr<PreprocessDataNode> node_ptr, std::string topic_name, std::string frame_id, int queue_size, int policy_history)
        : frame_id_(frame_id)
    {
        node_ptr_ = node_ptr;
