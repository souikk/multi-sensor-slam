 ...
 * @LastEditTime: 2022-08-26 16:50:07
 * @Description:
 */
...
{
    CloudPublisher::CloudPublisher(rclcpp::Node::SharedPtr node_ptr, std::string topic_name, std::string frame_id, int queue_size, int policy_history) : frame_id_(frame_id)
    {
        node_ptr_ = node_ptr;
    ...
    void CloudPublisher::publishMsg(CloudData cloud)
    {
        ...
        pcl::toROSMsg(*cloud.cloud_ptr_, msg);
        msg.header.frame_id =
