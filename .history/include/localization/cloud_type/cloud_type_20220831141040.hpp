 ...
 * @LastEditTime: 2022-08-31 14:10:40
 * @Description:
 */
#pragma once
...
POINT_CLOUD_REGISTER_POINT_STRUCT(MyPointXYZICR,
                                  (float, x, x)(float, y, y)(float, z, z)(uint8_t, intensity, intensity)(double, timestamp, timestamp)(uint16_t, ring, ring)(uint16_t, col, col))
