 ...
 * @LastEditTime: 2022-08-29 18:24:13
...
namespace localization
{
    ...
    {
    public:
        PreprocessDataFlow(std::shared_ptr<PreprocessDataNode> node_ptr);

        bool run();

    private:
        void initSubscriber(std::shared_ptr<PreprocessDataNode> node_ptr, const YAML::Node &config);
        void initPublisher(std::shared_ptr<PreprocessDataNode> node_ptr, const YAML::Node &config);
