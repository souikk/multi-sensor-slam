 ...
 * @LastEditTime: 2022-08-31 15:24:52
 * @Description:核心算法文件
 */
#pragma once
...
namespace localization
{
    ...
    private:
        ...
        bool deskewPoint(CloudData::pointType point);
        bool deskewCloud(CloudData::pointType current_cloud) double pointDistance(CloudData::pointType point);
